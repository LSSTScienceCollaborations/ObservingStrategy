...
%\vskip -4.0in
\centering\includegraphics[width=0.95\linewidth]{figs/variables/enigma_1189_PeriodogramPurity_OPSI_SkyMap.pdf}
...
%\includegraphics[angle=0,width=1.19\hsize:,clip]{figs/enigma1189_earlySNe.pdf}
%\vskip -4.0in
\centering\includegraphics[width=0.95\linewidth]{figs/variables/enigma_1189_Phase_Gap_MedianGap_OPSI_SkyMap.pdf}
\caption{The median phase gap for candidate Baseline Cadence \opsimdbref{db:baseCadence}.
The \MAF \MAFmetric{PhaseGapMetric} looks at periods between 3 and 35 days by default.}
...
%\includegraphics[angle=0,width=1.19\hsize:,clip]{figs/enigma1189_earlySNe.pdf}
%\vskip -4.0in
\centering\includegraphics[width=0.95\linewidth]{figs/variables/enigma_1189_Phase_Gap_LargestGap_OPSI_SkyMap.pdf}
\caption{The maximum phase gap for candidate Baseline Cadence \opsimdbref{db:baseCadence}.
The \MAFmetric{PhaseGapMetric} looks at periods between 3 and 35 days by default.}
...
\subsubsection{Phase Gap Metric \MAFmetric{PhaseGapMetric}}
...
\subsubsection{Period Deviation Metric \MAFmetric{PeriodDeviationMetric}}
