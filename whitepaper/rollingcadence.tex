...
In this section we describe a set of three experimental ``Swiss Cheese''
...
depth (characterized by the number of visits) builds up between
uniform cadence (\opsimdbref{db:RollingCadenceControl}) and rolling cadence
...
\subsubsection{Rolling Cadence Recommendations}
