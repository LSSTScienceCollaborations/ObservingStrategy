...
% @ivezic: please check the following sentences, requested by the Pub Board reviewer.
...
% @ivezic can you please unpack the SOCS acronym and add a sentence about what else this team will do, please? You can refer forward to MAF which is introduced and described in the next section (\ref{sec:intro:evaluation}).
...
online repository.
All of the community-delevoped \MAF metrics described in this paper can be found there; a complete listing of all available \MAF metrics is provided in the appendix.
...
% @ivezic: "How will the Project Scientist act? Through the PST, or...?" Can you please suggest some extra detail here, or clean up and ignore?
...
% @ivezic: Please verify or edit the above parenthetical clause, inserted in response to the Pub Board reviewer.
...
% @ivezic, @bwillman: Neither the v2.0 nor v3.0 white papers are referred to in the Table, but they are clearly called for in the text. Can you please check these references and make sure you are OK with them? @connolly: should we update the Table to refer to these WP updates?
...
% @ivezic: How will all this activity by the SSC and SOCS and
% Scheduler team interact with their work preparing for commissioning?
% The Pub Board reviewer asks, in particular, "is it then expected for
% the scheduler team to update the cadence before commissioning?"
% Great if you can give the text a quick read through and provide a
% comment or two on commissioning.
...
effort basis. \OpSim v4 will be delivered as a Docker\footnote{\url{https://www.docker.com/what-docker#/overview}} container and its
