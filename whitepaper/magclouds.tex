...
We have several important scientific goals:
\begin{enumerate}
...
Magellanic Clouds. These will need to be divided among a small set of
...
\new{In this section we give the common diagnostic metrics that the Magellanic Clouds
figures of merit will depend on. Many of these are defined elsewhare in this paper,
so in the end we will probably just refer to them here.}
...
% TO DO: KNUT AND DAVID: \input{} science sections here!
