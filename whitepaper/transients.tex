...
ability of LSST cadences to produce data useful for
various science goals. These case studies include SNe, GRBs, and GWs. For other
transient families (Novae, LBVs, TDEs) we provide more general information,
and invite the community to further develop the ideas proposed here into
quantified science cases.
...
heavily used throughout this chapter, in Sections ~\ref{sec:transientsAge},
~\ref{sec:SNtransients}, and~\ref{sec:gw} for example.

Further metrics relevant to transient science are discused in Chapters~\ref{chp:galaxy},~\ref{chp:cosmo}, and ~\ref{chp:variables}. 
...
to best guide LSST's time-domain observing strategy.
