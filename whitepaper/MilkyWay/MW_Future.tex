...
\new{This Section contains extremely brief initial notes for important
  science cases that (as of the current writing in mid-April 2016)
  have yet to be developed into figure-of-merit-ready investigations
  even at the level of pseudocode. However we do not want these
  invesigations to drop off the radar.}
...
\begin{itemize}
  \item {\it Formation history of the Bulge and present-day balance of populations:} Sensitivity to metallicity and age distribution of Bulge objects near the Main Sequence Turn-off;
    \item {\it Migration and heating in the Milky Way disk:} Error and bias in the determination of components in the
      ...
      populations at various lines of sight;
