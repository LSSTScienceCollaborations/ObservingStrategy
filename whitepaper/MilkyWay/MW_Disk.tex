...
\new{Here we answer the ten questions posed in \autoref{sec:intro:evaluation:caseConclusions}:}
...
\begin{description}
 ...
 \new{ \item[A1:] Figures of Merit addressing this question have been
   ...
   to the constraint that all fields experience LSST coverage in all
   filters throughout the full ten-year survey (a condition currently
   {\it not} satisfied by the current baseline cadence,
...
\new{ \item[A2:] The frequency of sampling is critical for the science
...
\new{ \item[A3:] This depends strongly on the line of sight,
  ...
  \opsimdbref{db:DoubleUbandExptimewithNESpur} in Chapter
 ...
 \new{\item[A4:] Yes. Galactic plane coverage (in most cases, the inner Plane)
...
\new{ \item[A5:] We do not have quantitative answers to this question
  ...
  reddening). To be most generally useful for static population
  studies (e.g. constraining reddening, $T_{eff}$~and
  $[Fe/H]$~photometrically following the manner of the SDSS tomography
  studies and described in the LSST science book), coverage in at
...
\new{ \item[A6:] The science cases in this chapter do not place any
...
\new{ \item[A7:] Qualitatively, visits in two different filters are weakly preferred. Science cases requiring discrimination of
...
\new{ \item[A8:] No, as long as all fields obtain at least some
...
\new{ \item[A9:] At this stage we do not believe that any special
...
\new{ \item[A10:] Not as long as the achieved limiting depth is accurately
