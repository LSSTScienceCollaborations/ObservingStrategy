...
\item \new{{\it \bf Results:} $FoM_{preSN}$(enigma-1189) = 0.129, while $FoM_{preSN}$(ops2-1092)=0.826.\footnote{\new{2016-04-25 For comparison, when run on 2015-era OpSim runs {\it enigma\_1189} (Baseline strategy) and {\it ops2\_1092} (PanSTARRS-like strategy) the results were 0.251 (Baseline) and 0.852 (PanSTARRS-like strategy). So the 2016-era OpSim runs show a sharper disadvantage than before to the Baseline cadence for the Galactic Supernova case.}} See Figure \ref{f_opSim_GalacticSN} for a breakdown of this figure of merit across sightlines.}
