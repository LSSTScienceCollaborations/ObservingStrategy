...
\new{Below we provide more detail on these science cases, including
  ...
  detail elsewhere (in the LSST Science Book or the \citet{IvezicEtal2008}
  summary paper).}
...
cases. \new{See Table \ref{tab_SummaryMWDisk} at the end of this subsection for initial efforts along these lines.}
...
baseline (see figure \ref{fig_astrom_ByTime_pmError} of Section
