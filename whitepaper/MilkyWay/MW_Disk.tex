...
\new{\it Possible higher-order metrics:} Error on the rate of Type Ia
...
while
$FoM_{preSN}$(\opsimdbref{db:opstwoPS})=0.826.\footnote{\new{2016-04-25
...
\new{See Table \ref{tab_SummaryMWDisk} at the end of this subsection for
