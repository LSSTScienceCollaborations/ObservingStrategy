...
\credit{pmmcgehee}, \credit{willclarkson}
...
extragalactic sources. \new{Recent work on 3-D maps include the
  Bayesian analysis method based on Pan-STARRS--1 (PS1) data (Green et
  al. 2015, ApJ, 810, 25) and an alternative technique using SDSS
...
\new{While the PS1 3-D dust map is a significant advance, it suggests a
...
Plane towards the South. Secondly, the PS1 map (Schlafly et al.~2014)
...
\new{The SDSS approach is complementary, and makes use of reddening-free
colors defined in the SDSS $ugriz$~system by McGehee et
al. (2005). This approach makes use of M dwarf locus in $(g-r,r-i)$
...
intrinsic stellar $g-i$ color and subsequent deterimation of the
...
\new{Production of a 3-D map of the dust component of the ISM based on
...
\new{With the possible exception of sightlines towards star formation
...
\begin{table}
  ...
  \end{tabular}
\caption{Summary of figures-of-merit for ISM science cases. The best value of each FoM is indicated in bold. Runs \opsimdbref{db:baseCadence} and \opsimdbref{db:opstwoPS} refer to the Baseline and PanSTARRS-like strategies, respectively. See Section \ref{sec:MW_Disk}. }
