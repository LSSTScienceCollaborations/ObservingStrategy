...
\credit{dgmonet},
\credit{caprastro},
{\it Dana I. Casetti-Dinescu, John Gizis, Michael Liu and others to follow}
...
\new{LSST should produce significant contributions to essentially all
  ...
  chapters 6 and 7) and Ivezic et al. (2008 arXiv 0805.2366, in
  particular Sections 2.1.4 and 4.4 of that document).\footnote{We do
    however provide motivating details for certain science cases in
    ...
    sections of Ivezic et al. (2008).} As with the rest of this
...
\new{Concern about observations towards the inner Galactic Plane has
  ...
  latitudes\footnote{At the time of writing, observations towards the
    ...
    observations away from the Plane (see e.g. Figure
    \ref{fig_astrom_ByTime_pmError} in Section
...
exclusively in the Plane.  \new{Section \ref{sec:MW_SFH} discusses the
