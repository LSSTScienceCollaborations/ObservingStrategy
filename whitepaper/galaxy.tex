...
%\subsubsection{Formation History and Evolution of the Milky Way as traced by st%ar clusters}
%\vspace{-2mm}
%\begin{itemize}
%\item {\bf Observing requirement:} Deep \{ugrizy\} photometry down to 2 magnitu%des below the main sequence turn-off (required); astrometric precision to remov%e foreground contamination in regions too crowded for gaia (preferred).
%\vspace{-2mm}
