...
that have been identified, and how these could be mitigated. {\it The
comparisons between different simulated strategies will help make the
case for any changes to the baseline strategy, and in the short term
...
new \OpSim simulation runs.}} \new{For some science sections
we will have only a metric design, without an implementation.
Subsequent versions of this white paper will hopefully see these designs
realized and put into action. For now, though, the discussion of risks to these science cases
will necessarily be minimal, containing only predictions for how the figure of merit will
vary among observing strategies.}
