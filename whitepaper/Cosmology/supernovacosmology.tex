...
most exciting and fundamental discoveries of this
...
extremely 
important
for SN cosmology goals as the success of SN Ia cosmology has always been
based on the empirical model that intrinsic peak brightnesses are
related to the certain observable characteristics of SNe.  The WFD SN Ia
...
due to deviations from the empirical model. The anticipated WFD sample can
...
in the science image compared to the template) to sky noise (SNR) in the relevant image.
...
SN IIP) for cosmology requires estimating the intrinsic brightness of each SN. The first (and 
...
a
 function of the signal-to-noise as obtained from Dark Energy Survey, (R. Kessler, priv. 
communication). It shows, 
that 
...
defined in \citet{Lochner2016}, which is a good balance between purity and completeness. Ideally, 
...
classification a very difficult metric to include on the per-object level.
...
of the intrinsic dispersion. When added up over SNe to obtain a value
