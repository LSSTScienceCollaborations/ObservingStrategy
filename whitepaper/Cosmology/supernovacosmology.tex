...
will be discovered if it occurs with the spatio-tempoal window of LSST. We use this as the perSNmetric 
value for the discovery metric. While very high redshift (and thus dim) supernovae will not be discovered, it is 
potentially possible to discover many supernovae whose light curves will not be well characterized or hard to classify.
