...
Randomization of camera angle covering 180 deg can effictively suppress
residual shear systematics remaining after DM pipleine first-order
correction.   More simulations are required, using intelligent
dithering, in order to assess the efficinecy and the remaing WL shear
systematics.
