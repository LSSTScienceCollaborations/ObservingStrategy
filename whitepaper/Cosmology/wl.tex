...
brighter calibation stars in the field are propagated to errors in the galaxy
...
Simulations which add camera angle dithering show that the residual sgear
...
tends in photometric redshift.  These trends must be understood, if not
minimized.
...
will be used for data analysis, thse PSF effects will be inherited for each
...
course, the requirements for spatial dithering for shear systematics residual
...
is required to sample the growth of dark matter structure from low redshit to
