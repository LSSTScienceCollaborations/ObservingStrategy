...
at $z\geq6$. Currently, for enigma_1189, the single-epoch 5-sigma depth in $Y$
is 22.36 mag, and for the final co-added 5-sigma depth is $Y=24.4$. These limits are
deeper than the original predictions (see AAS poster from 2013). Need to compare these
numbers to the output from other OpSims.
