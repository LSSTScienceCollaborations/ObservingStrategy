...
discusses potential effects of the Observing Strategy on AGN continuum
(or disk) variability. Section~\ref{sec:AGNMicrolensing} describes how the
LSST cadence may affect estimates or constraints on the size and structure
of the AGN central engine from observations of microlensing events.
Section~\ref{sec:AGNBELR} discusses potential cadence effects on
measurements related to the broad emission line region in AGNs.
