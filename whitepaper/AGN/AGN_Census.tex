...
As noted at the beginning of this section, the main FoM for AGN
science is maximizing the number of AGNs detected.  As the co-added
depth is already pushing well into the regime of low-luminosity AGNs
that suggests that area is preferred over depth.  It should be
possible to do a MAF analysis to determine the relative selection
completeness and efficiency for opSims with different
uniformity/frequency of sampling---similarly for constraining the
fraction of observing time in each band (where $u$ is the most
important for $z<\sim3$) and for determining whether nightly visits
should be in the same band or not.  The same goes for the trade-off of
single-visit depth and number of visit, but the AGN census is unlikely
to be the driver in these decisions.  Given the desire for maximal
area, added Galactic plane coverage would be detrimental to AGN
science.  Nearly any cadence discussed for the deep drilling fields
...
commissioning would enable more robust truth tables.  The census of
AGNs is unlikely to be the determining factor in terms of observing
conditions and does not require nearly constant single-visit depths.
