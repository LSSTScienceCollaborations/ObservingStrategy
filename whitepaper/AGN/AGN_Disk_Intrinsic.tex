...
\begin {enumerate}
\item having the longest-possible temporal baseline i.e. interval between
the first and last observations, is mandatory. The temporal baseline
\emph{must} be atleast 2-3 $\times$ the longest timescale ($\tau$) built
into the light curve \citep{2017A&A...597A.128K}. \citet{2010ApJ...721.1014M}
find that $\max \tau \sim 1000$ d suggesting that survey strategy strategies
that do not visit every field at both the beginning and end of the survey will
be sub-optimal for this science case.
\item having intervals of time during which the survey is performed with
higher sampling frequency is mandatory. Fig. \ref{fig:PSDvsFreq} demonstrates
...
\item[A3:] The disc-intrinsic variability science case is best benefited by a
survey strategy that maximizes the number of visits.

\item[Q4:] {\it Does the science case place any constraints on the
Galactic plane coverage (spatial coverage, temporal sampling, visits per
band)?}

\item[A4:] The disc-intrinsic variability science case places no constraints on
the Galactic plane coverage.

\item[Q5:] {\it Does the science case place any constraints on the
fraction of observing time allocated to each band?}

\item[A5:] The disc-intrinsic variability science case places no constraints on
the fraction of observing time allocated to each band.

\item[Q6:] {\it Does the science case place any constraints on the
cadence for deep drilling fields?}

\item[A6:] The disc-intrinsic variability science case places the same constraints
on the DDFs as it does on the WFD survey. See the answer to Q2 for details.
