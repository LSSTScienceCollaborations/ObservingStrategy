...
Figure~\ref{fig:sndetect} shows the detection rate for SN~Ia at $z=0.5$ in absence of shock interaction as a function of SNR (product of $g'$ and $r'$ limit) for 3, 6 months, and a year of \opsimdbref{db:baseCadence} (ideally I will plot it for the aother survey as well tonight) 
