...
\href{http://ops2.lsst.org:8282}{simulated surveys} is presented here,
...
and adopted as the new Baseline Cadence by the Change Control Board in August 
2016.}
...
demonstrate that the ``survey reserve'', relative to the WFD 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\opsimdb[db:DoubleUbandExptimewithNESpur]{kraken\_1059}{Baseline Cadence, but with doubled $u$ band exp.\ time, halved num.\ visits.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{\bf Analysis Results:}  This simulated cadence is named
\opsimdbref{db:DoubleUbandExptimewithNESpur}.  Compared to the Baseline
