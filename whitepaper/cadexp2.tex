...
depend on externally supplied values for fiducial zentih dark time single-epoch
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\opsimdb[db:DoubleUbandExptimewithNESpur]{kraken\_1059}{Baseline Cadence, but with doubled $u$-band exp.\ time.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
including the North Ecliptic Spur, South Celectial Pole, or Deep Drilling Fields
in this simulation).
