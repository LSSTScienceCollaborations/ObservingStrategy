...
\begin{tabular}{lll}
& \multicolumn{2}{c}   {Median Number of Visits (per field, per filter)} \\
    & \opsimdbref{db:baseCadence} &
                                    \opsimdbref{db:NormalGalacticPlane} \\
WFD $u$ & 62 & 59 \\
WFD $g$ & 88 & 83 \\ 
WFD $r$ & 201 & 189 \\
WFD $i$ & 200 & 189 \\
WFD $z$ & 180 & 170 \\
WFD $y$ & 181 & 170 \\
 & \multicolumn{2}{c}   {Median Coadded Depth (per field, per filter)} \\
    & \opsimdbref{db:baseCadence} &
                                    \opsimdbref{db:NormalGalacticPlane} \\
WFD $u$ & 25.46 & 25.42 \\
WFD $g$ & 26.95 & 26.91 \\
