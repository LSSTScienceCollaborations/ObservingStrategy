...
Simulations that only implemented Universal Cadence proposal imply a 11best-case 
...
main survey fields in \opsimdbref{db:baseCadence}. The position angle is the angle between ``up'' in the image
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\opsimdb[opstwoPS]{minion\_1020}{A Pan-STARRS-like observing strategy.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
