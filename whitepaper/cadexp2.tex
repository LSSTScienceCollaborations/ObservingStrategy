...
left to Chapter~\ref{ch:solarsystem}, in particular the impact on
completeness is evaluated in Section~\ref{sec:solarsystem:discovery}.
...
The peak median inter-night revisit rate is about 3 days for the
