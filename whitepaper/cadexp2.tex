...
as \href{http://www.astro.washington.edu/users/ivezic/lsst/cadexp2.pdf}{an LSST DM Sims standalone report})
...
special programs in \opsimdbref{db:enigma} are not responsible for this bias).
\end{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\opsimdb[db:opstwoPS]{ops2\_1092}{A Pan-STARRS-like observing strategy.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
