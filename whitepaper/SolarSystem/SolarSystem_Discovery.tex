...
The \MAFmetric{DiscoveryChancesMetric} can be used to identify sets of
...
each object. The results from the \MAFmetric{DiscoveryChancesMetric} can be fed to the
\MAFmetric{MoCompletenessMetric} summary metric, where if an object achieves
...
The basic output from the \MAFmetric{DiscoveryChancesMetric} is the number
...
given H magnitude with the \MAFmetric{MoCompletenessMetric} summary metric.
...
% PJM: need shorter filenames for arxiv
...
\begin{figure}
% PJM: the following filenames are too long for the arxiv! Made copies:
%
