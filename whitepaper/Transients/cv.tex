...
%
% \item[A3:] In u, increasing the number of $u$-band visits will improve the characterization of CV phenomena.
%
...
% area?}
%
% \item[A8:] High cadence observations in multiple filters would jumpstart the science and help to confirm the
%best strategy.
%
