...
%
% \item[A7:] If two visits only, different filters may be the most effective. If more than two visits, the most closely spaced
%pair should be in the same filter, and the other visits should include at least one other filter.
%
