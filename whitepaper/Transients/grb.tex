...
% band)?}
%
% \item[A4:] This science will be away from the galactic plane, and best away from the ecliptic as well.
%
...
%
% \item[A7:] At least three visits per night in the same filter is the strong preference.
%
...
% area?}
%
% \item[A8:] Enhanced cadences at high galactic latitude would provide early GRB detections.
%
