...
* **[Read the current draft of the white paper](http://www.slac.stanford.edu/~pjm/LSST/ObservingStrategy/whitepaper/LSST_Observing_Strategy_White_Paper.pdf)** (Automatically updated every hour, [log file here](http://www.slac.stanford.edu/~pjm/LSST/ObservingStrategy/whitepaper/LSST_Observing_Strategy_White_Paper.log).)
